/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 5c3f78e8239be17e19b59577d80bb495)
// Runtime types generated with workerd@1.20260910.1 2025-05-05 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* fractional-hr-site-qa */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface QaEnv {
		...
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* fractional-hr-site-qa */;
	}
