        ...
        <div className="mx-auto max-w-4xl px-6 py-20">
          <div className="space-y-12">
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                ...
                <ul className="list-disc space-y-2 pl-6">
                  ...
                  <li>Information you choose to provide when completing the HR Operations Health Check, such as company size, industry, role, country or region, and optional contact details</li>
                  <li>Your responses to the HR Operations Health Check questions, together with the resulting score and related benchmark data</li>
                  <li>Basic technical information needed for the website to function properly, maintain security, and support performance monitoring</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                ...
                <ul className="list-disc space-y-2 pl-6">
                  ...
                  <li>Generate and display HR Operations Health Check results</li>
                  <li>Analyse diagnostic trends and create aggregated, anonymised, or de-identified benchmarking insights</li>
                  <li>Improve the website, services, and diagnostic experience</li>
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                <p>
                  Depending on the context, personal data is processed on one or more
                  of the following bases:
                </p>
                <ul className="list-disc space-y-2 pl-6">
                  <li>To take steps at your request before entering into a business relationship</li>
                  <li>For legitimate interests in running and improving the website, responding to enquiries, and understanding broad patterns in HR operational maturity</li>
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                <p>
                  ...
                  self-assessment tool. Information submitted through the tool may be
                  used to generate your result, understand common operational patterns,
                  and improve the quality of the diagnostic over time.
                </p>
                <p>
                  Where benchmark or trend information is created from diagnostic
                  submissions, it is intended to be used in aggregated or anonymised
                  form so that individual organisations are not identified.
                </p>
                <p>
                  If you choose to provide contact details in connection with the
                  diagnostic, those details may be used to respond to your request,
                  discuss the result, or provide further interpretation of the
                  diagnostic.
                </p>
              </div>
            </section>
            ...
            <section>
              <p className="brand-section-kicker">Technical and identifier data</p>
              <h2 className="brand-heading-md mt-3 text-slate-950">
              ...
              <div className="brand-body mt-4 space-y-4">
                ...
                <p>
                  Where possible, the intention is to minimise the storage of directly
                  identifying technical data. If identifiers are used for fraud
                  prevention, rate limiting, or deduplication, they may be transformed,
                  tokenised, hashed, truncated, or otherwise handled in a privacy-aware
                  way rather than retained in raw form unless there is a specific
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                <p>
                  Personal data may be shared with service providers who support the
                  operation of the website, website hosting, analytics, form handling,
                  or diagnostic data processing, where necessary and subject to
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                <p>
                  ...
                  relevant purpose, including responding to enquiries, maintaining
                  business records, operating and improving the diagnostic, and meeting
                  legal or regulatory obligations where applicable.
                </p>
                <p>
                  Aggregated or anonymised benchmarking information may be retained for
                  longer where it no longer identifies an individual.
                </p>
              </div>
            </section>

            <section>
              <p className="brand-section-kicker">International transfers</p>
              <h2 className="brand-heading-md mt-3 text-slate-950">
                Where data may be processed
              </h2>
              <div className="brand-body mt-4 space-y-4">
                <p>
                  Depending on the service providers used to operate the website,
                  personal data may be processed in countries outside the UK. Where that
                  happens, reasonable steps will be taken to use appropriate safeguards
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                <p>
                  Depending on the applicable law and circumstances, you may have rights
                  to request access, correction, erasure, restriction, objection, or
                  portability in relation to your personal data.
                </p>
                <p>
                ...
                <p>
                  You may also have the right to complain to a relevant supervisory
                  authority.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                <p>
                  If you have any questions about this Privacy Policy or how personal
                  data is handled, you can contact me directly.
                </p>
                <p>
                  Email:{" "}
            ...
            <section>
              ...
              <div className="brand-body mt-4 space-y-4">
                <p>
                  This policy may be updated from time to time to reflect changes to the
                  website, services, diagnostic features, or legal requirements.
                </p>
              </div>
            </section>
          </div>
