...
}<section className="border-t border-slate-200 bg-[#F4F6FA]">
  <div className="brand-container brand-section">
    <div className="brand-surface-soft rounded-[2rem] p-8 lg:p-10">
      <div className="max-w-3xl brand-stack-md">
        <div className="brand-stack-sm">
          ...
          <p className="brand-subheading text-slate-700">
            This diagnostic highlights where operational friction is likely
            building. The next step is understanding what is causing it and
            what should be prioritised first.
          </p>

          <p className="brand-body">
            A short diagnostic conversation helps translate this into practical
            next steps based on your organisation, operating model, and current
            priorities.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 pt-2">
          <Link
            href="/contact?topic=Diagnostic%20Interpretation&source=health-check"
        ...
        <p className="text-sm text-slate-500">
          No preparation needed. We use your responses as the starting point.
        </p>
      </div>
    </div>
  </div>
